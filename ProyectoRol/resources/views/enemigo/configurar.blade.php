<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-primary leading-tight">
            {{ __('Gestión de enemigo:') }} '{{$entidad->nombre}}'
        </h2>
    </x-slot>
    @if(isset($msj))
        ...
        <div class="m-auto w-5/6 h-4/5">
            <div class="container mx-auto px-4 sm:px-8">
                <div class="py-8">
                                            ...
                                            <div x-data="{ open: false }">
                                                ...
                                                <div class="absolute top-0 left-0 sm:top:1/2 flex items-center justify-center w-full h-full" x-show="open">
                                                    <div class="h-auto p-4 mx-1 text-left bg-primary1 rounded shadow-xl md:max-w-xl md:p-6 lg:p-8 md:mx-0 border border-primary" @click.away="open = false">
                                                        <div class="mt-1">
                                                            <div class="mt-1">
                                                                <h1 class="text-lg text-primary">¿Deseas borrar el objeto del enemigo?</h1>
                                                                <div class="flex">
                    ...
                    @else
                        <p>No existen habilidades ligadas a este enemigo, pruebe a crear una o añadir de las ya existentes!<p>
                    @endif
